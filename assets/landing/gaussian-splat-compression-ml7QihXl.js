...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, n, r) => n in e ? t(e, n, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: r
}) : e[n] = r, s = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), c = (e, n) => {
	...
	value: n,
	enumerable: !0
}) : a, n)), d = (e, t, n) => (o(e, typeof t == "symbol" ? t : t + "", n), n), f = s((e, t) => {
	function n(e) {
	...
	var n = f(), r = p(), i = typeof Float64Array < "u";
	function a(e, t) {
		return e[0] - t[0];
	}
	function o() {
	...
	function u(e, t, n, r) {
		...
		typeof e == "number" && (e = [e]), t === void 0 && (t = [e.length]);
		var a = t.length;
		if (n === void 0) {
			n = Array(a);
			...
			if (!(s.count <= 0)) {
				...
				switch (t.argTypes[o]) {
					...
					case "index":
						r = r.replace(c, "index");
						break;
					case "shape": r = r.replace(c, "shape");
				}
			}
		}
		return [
	...
	function c(e, t) {
		...
		for (var d = 0; d < e.offsetArgs.length; ++d) {
			for (var C = e.offsetArgs[d], w = [], v = 0; v < C.offset.length; ++v) C.offset[v] !== 0 && (C.offset[v] === 1 ? w.push([
				"t",
				C.array,
				"p",
				v
...
}), b = u(m(), 1), x = u(y(), 1), S = u(m(), 1), C = u(y(), 1), w = class {
	constructor(e, t, n) {
		this._dataNormalized = e, this._minD = t, this._maxD = n;
	}
	static createFromUnnormalized(e) {
		let t = C.sup(e), n = C.inf(e), r = (0, S.default)(new Float32Array(e.size), e.shape), i = t - n;
		return i < 1e-4 ? C.assigns(r, 0) : (C.subs(r, e, n), C.divs(r, r, i)), new w(r, n, t);
	}
	get data() {
	...
	denormalize() {
		let e = (0, S.default)(new Float32Array(this._dataNormalized.size), this._dataNormalized.shape);
		return C.muls(e, this._dataNormalized, this._maxD - this._minD), C.adds(e, e, this._minD), e;
	}
}, T = class {
	constructor(e, t) {
	...
	static fromNormalized(e, t) {
		let n = e.data, r;
		if (t === "norm8x") {
			let e = T.maxIntBits(8), t = (0, S.default)(new Float32Array(n.size), n.shape);
			C.muls(t, n, e), C.roundeq(t), r = (0, S.default)(new Uint8Array(t.data), n.shape);
		} else if (t === "norm565") {
			let e = (0, S.default)(new Float32Array(n.size), n.shape);
			C.assign(e, n), C.mulseq(e.pick(null, 0), T.maxIntBits(5)), C.mulseq(e.pick(null, 1), T.maxIntBits(6)), C.mulseq(e.pick(null, 2), T.maxIntBits(5)), C.roundeq(e);
			let t = (0, S.default)(new Uint16Array(e.data), n.shape), i = (0, S.default)(new Uint16Array(n.shape[0]), [n.shape[0]]), a = (0, S.default)(new Uint16Array(n.shape[0]), [n.shape[0]]);
			C.lshifts(i, t.pick(null, 0), 11), C.lshifts(a, t.pick(null, 1), 5), C.boreq(i, a), C.boreq(i, t.pick(null, 2)), r = i;
		} else {
			let e = (0, S.default)(new Float32Array(n.size), n.shape);
			C.assign(e, n), C.mulseq(e.pick(null, 0), T.maxIntBits(11)), C.mulseq(e.pick(null, 1), T.maxIntBits(10)), C.mulseq(e.pick(null, 2), T.maxIntBits(11)), C.roundeq(e);
			let t = (0, S.default)(new Uint32Array(e.data), n.shape), i = (0, S.default)(new Uint32Array(n.shape[0]), [n.shape[0]]), a = (0, S.default)(new Uint32Array(n.shape[0]), [n.shape[0]]);
			C.lshifts(i, t.pick(null, 0), 21), C.lshifts(a, t.pick(null, 1), 11), C.boreq(i, a), C.boreq(i, t.pick(null, 2)), r = i;
		}
		return new T(r, t);
	}
	dequantize(e, t) {
		let n = this._method, r, i = this._quantized;
		if (n === "norm8x") {
			let e = T.maxIntBits(8);
			r = (0, S.default)(new Float32Array(i.size), i.shape), C.muls(r, i, 1 / e);
		} else if (n === "norm565") {
			let e = (0, S.default)(new Uint8Array(i.shape[0]), [i.shape[0]]), t = (0, S.default)(new Uint8Array(i.shape[0]), [i.shape[0]]), n = (0, S.default)(new Uint8Array(i.shape[0]), [i.shape[0]]);
			C.rrshifts(e, i, 11), C.rrshifts(t, i, 5), C.bandseq(t, T.maxIntBits(6)), C.bands(n, i, T.maxIntBits(5)), r = (0, S.default)(new Float32Array(i.shape[0] * 3), [i.shape[0], 3]), C.muls(r.pick(null, 0), e, 1 / T.maxIntBits(5)), C.muls(r.pick(null, 1), t, 1 / T.maxIntBits(6)), C.muls(r.pick(null, 2), n, 1 / T.maxIntBits(5));
		} else {
			let e = (0, S.default)(new Uint16Array(i.shape[0]), [i.shape[0]]), t = (0, S.default)(new Uint16Array(i.shape[0]), [i.shape[0]]), n = (0, S.default)(new Uint16Array(i.shape[0]), [i.shape[0]]);
			C.rrshifts(e, i, 21), C.rrshifts(t, i, 11), C.bandseq(t, T.maxIntBits(10)), C.bands(n, i, T.maxIntBits(11)), r = (0, S.default)(new Float32Array(i.shape[0] * 3), [i.shape[0], 3]), C.muls(r.pick(null, 0), e, 1 / T.maxIntBits(11)), C.muls(r.pick(null, 1), t, 1 / T.maxIntBits(10)), C.muls(r.pick(null, 2), n, 1 / T.maxIntBits(11));
		}
		return new w(r, e, t);
	}
}, E = class {
	constructor(e, t, n, r, i, a = !1) {
		this._quantized = e, this._minMaxMatrix = t, this._chunkSize = n, this._quantizationMethod = r, this._variableChunkSize = i, this._isDynamicChunks = a;
	}
	get length() {
	...
	_createPrunedMinMax(e) {
		let t = e.length, n = this.minmaxMatrix.shape[0] - t, r = (0, b.default)(new Float32Array(n * 2), [n, 2]), i = 0, a = n, o = 0, s = this.minmaxMatrix.shape[0];
		for (let t = 0; t < e.length; t++) s = e[t], a = s - o + i, a > i && x.assign(r.hi(a, 2).lo(i, 0), this.minmaxMatrix.hi(s, 2).lo(o, 0)), i = a, o = s + 1;
		return i < n && x.assign(r.lo(i, 0), this.minmaxMatrix.lo(o, 0)), r;
	}
	_createPrunedQuantized(e) {
		let t = e.length, n = this.quantized.shape[0] - t, r = this._quantizationMethod, i, a;
		if (r === "norm8x") {
			a = this._quantized.shape[1];
			let e = a ? n * a : n;
			i = (0, b.default)(new Uint8Array(e), a ? [n, a] : [n, 1]);
		} else i = r === "norm565" ? (0, b.default)(new Uint16Array(n), [n]) : (0, b.default)(new Uint32Array(n), [n]);
		let o = 0, s = n, c = 0, l = i.shape[0];
		for (let t = 0; t < e.length; t++) l = e[t], s = l - c + o, s > o && (a ? x.assign(i.hi(s, a).lo(o, 0), this._quantized.hi(l, a).lo(c, 0)) : x.assign(i.hi(s).lo(o), this._quantized.hi(l).lo(c))), o = s, c = l + 1;
		return o < n && (a ? x.assign(i.lo(o, 0), this._quantized.lo(c, 0)) : x.assign(i.lo(o), this._quantized.lo(c))), i;
	}
	pruneFeature(e, t, n) {
		return new E(this._createPrunedQuantized(e), this._createPrunedMinMax(t), this._chunkSize, this._quantizationMethod, n, !0);
	}
	static getRequiredNChunks(e, t) {
		return Math.floor(e / t);
	}
	static fromArray(e, t, n) {
		let r = e.shape[0], i = Math.floor(r / n), a = (0, b.default)(new Float32Array(i * 2), [i, 2], [2, 1]), o;
		o = t === "norm8x" ? (0, b.default)(new Uint8Array(e.size), e.shape) : t === "norm565" ? (0, b.default)(new Uint16Array(e.shape[0]), [e.shape[0]]) : (0, b.default)(new Uint32Array(e.shape[0]), [e.shape[0]]);
		for (let s = 0; s < i; s++) {
			let c = s * n, l = s + 1 < i ? (s + 1) * n : r, u;
			u = e.shape.length > 1 ? w.createFromUnnormalized(e.hi(l, e.shape[1]).lo(c, 0)) : w.createFromUnnormalized(e.hi(l).lo(c)), a.set(s, 0, u.minD), a.set(s, 1, u.maxD), o.shape.length > 1 ? x.assign(o.hi(l, o.shape[1]).lo(c, 0), T.fromNormalized(u, t).quantized) : x.assign(o.hi(l).lo(c), T.fromNormalized(u, t).quantized);
		}
		return new E(o, a, n, t);
	}
	denormDequant() {
		let e = this._minMaxMatrix.shape[0], t = this._quantized, n = t.shape[0], r = this._quantizationMethod, i = this._chunkSize, a;
		...
		let o;
		o = r === "norm8x" ? (0, b.default)(new Float32Array(t.size), t.shape) : (0, b.default)(new Float32Array(n * 3), [n, 3]);
		let s = 0, c = i;
		for (let i = 0; i < e; i++) {
			let [l, u] = [this._minMaxMatrix.get(i, 0), this._minMaxMatrix.get(i, 1)];
			this._isDynamicChunks && (c = a[i]);
			let d = i + 1 < e ? s + c : n, f;
			f = t.shape.length > 1 ? new T(t.hi(d, t.shape[1]).lo(s, 0), r) : new T(t.hi(d).lo(s), r), x.assign(o.hi(d, o.shape[1]).lo(s, 0), f.dequantize(l, u).denormalize()), s = d;
		}
		return o;
	}
...
}, D = u(m(), 1), O = u(y(), 1), k = "http://127.0.0.1:8000", A = u(m(), 1), j = u(y(), 1), M = [
	1,
	10,
	100,
	1e3,
...
function P(e, t) {
	...
	if (~~e === e && ~~t === t) {
		...
		let n = N(e), r = N(t), i = 0;
		return n < r ? (e *= M[r - n - 1], t /= 10, i = -1) : n > r && (t *= M[n - r - 1], e /= 10, i = 1), e === t ? i : e < t ? -1 : 1;
	}
	...
	for (r === t && r++; r < n; r++) {
		...
		switch (s) {
			...
			case 1:
				e[a + 1] = e[a];
				break;
			default: for (; s > 0;) e[a + s] = e[a + s - 1], s--;
		}
		e[a] = n;
	}
}
...
function L(e, t, n, r, i, a) {
	...
	for (o++; o < c;) {
		let r = o + (c - o >>> 1);
		a(e, t[n + r]) < 0 ? c = r : o = r + 1;
	}
	return c;
}
var re = class {
	constructor(e, t) {
		d(this, "array", null), d(this, "compare", null), d(this, "minGallop", 7), d(this, "length", 0), d(this, "tmpStorageLength", 256), d(this, "stackLength", 0), d(this, "runStart", null), d(this, "runLength", null), d(this, "stackSize", 0), this.array = e, this.compare = t, this.length = e.length, this.length < 512 && (this.tmpStorageLength = this.length >>> 1), this.tmp = Array(this.tmpStorageLength), this.stackLength = this.length < 120 ? 5 : this.length < 1542 ? 10 : this.length < 119151 ? 19 : 40, this.runStart = Array(this.stackLength), this.runLength = Array(this.stackLength);
	}
	pushRun(e, t) {
	...
	mergeAt(e) {
		let t = this.compare, n = this.array, r = this.runStart[e], i = this.runLength[e], a = this.runStart[e + 1], o = this.runLength[e + 1];
		this.runLength[e] = i + o, e === this.stackSize - 3 && (this.runStart[e + 1] = this.runStart[e + 2], this.runLength[e + 1] = this.runLength[e + 2]), this.stackSize--;
		let s = L(n[a], n, r, i, 0, t);
		r += s, i -= s, i !== 0 && (o = I(n[r + i - 1], n, a, o, o - 1, t), o !== 0 && (i <= o ? this.mergeLow(r, i, a, o) : this.mergeHigh(r, i, a, o)));
	}
	mergeLow(e, t, n, r) {
		let i = this.compare, a = this.array, o = this.tmp, s = 0;
		for (s = 0; s < t; s++) o[s] = a[e + s];
		let c = 0, l = n, u = e;
		if (a[u++] = a[l++], --r === 0) {
			for (s = 0; s < t; s++) a[u + s] = o[c + s];
			return;
		}
		if (t === 1) {
			for (s = 0; s < r; s++) a[u + s] = a[l + s];
			a[u + r] = o[c];
			return;
		}
		...
		for (;;) {
			...
			do
				if (i(a[l], o[c]) < 0) {
					if (a[u++] = a[l++], n++, e = 0, --r === 0) {
						f = !0;
						break;
					}
				} else if (a[u++] = o[c++], e++, n = 0, --t === 1) {
					f = !0;
					break;
				}
			while ((e | n) < d);
			if (f) break;
			do {
				if (e = L(a[l], o, c, t, 0, i), e !== 0) {
					for (s = 0; s < e; s++) a[u + s] = o[c + s];
					if (u += e, c += e, t -= e, t <= 1) {
						f = !0;
						break;
					}
				...
				if (n = I(o[c], a, l, r, 0, i), n !== 0) {
					for (s = 0; s < n; s++) a[u + s] = a[l + s];
					if (u += n, l += n, r -= n, r === 0) {
						f = !0;
						break;
					}
		...
		if (this.minGallop = d, d < 1 && (this.minGallop = 1), t === 1) {
			for (s = 0; s < r; s++) a[u + s] = a[l + s];
			a[u + r] = o[c];
		} else {
			if (t === 0) throw Error("mergeLow preconditions were not respected");
			for (s = 0; s < t; s++) a[u + s] = o[c + s];
		}
	}
	mergeHigh(e, t, n, r) {
		let i = this.compare, a = this.array, o = this.tmp, s = 0;
		for (s = 0; s < r; s++) o[s] = a[n + s];
		let c = e + t - 1, l = r - 1, u = n + r - 1, d = 0, f = 0;
		if (a[u--] = a[c--], --t === 0) {
			for (d = u - (r - 1), s = 0; s < r; s++) a[d + s] = o[s];
			return;
		}
		if (r === 1) {
			for (u -= t, c -= t, f = u + 1, d = c + 1, s = t - 1; s >= 0; s--) a[f + s] = a[d + s];
			a[u] = o[l];
			return;
		}
		...
		for (;;) {
			...
			do
				if (i(o[l], a[c]) < 0) {
					if (a[u--] = a[c--], n++, m = 0, --t === 0) {
						h = !0;
						break;
					}
				} else if (a[u--] = o[l--], m++, n = 0, --r === 1) {
					h = !0;
					break;
				}
			while ((n | m) < p);
			if (h) break;
			do {
				if (n = t - L(o[l], a, e, t, t - 1, i), n !== 0) {
					for (u -= n, c -= n, t -= n, f = u + 1, d = c + 1, s = n - 1; s >= 0; s--) a[f + s] = a[d + s];
					if (t === 0) {
						h = !0;
						break;
					}
				...
				if (m = r - I(a[c], o, 0, r, r - 1, i), m !== 0) {
					for (u -= m, l -= m, r -= m, f = u + 1, d = l + 1, s = 0; s < m; s++) a[f + s] = o[d + s];
					if (r <= 1) {
						h = !0;
						break;
					}
		...
		if (this.minGallop = p, p < 1 && (this.minGallop = 1), r === 1) {
			...
			if (r === 0) throw Error("mergeHigh preconditions were not respected");
			for (d = u - (r - 1), s = 0; s < r; s++) a[d + s] = o[s];
		}
	}
};
function ie(e, t, n, r) {
	if (!Array.isArray(e)) throw TypeError("Can only sort arrays");
	t ? typeof t != "function" && (r = n, n = t, t = P) : t = P, n ||= 0, r ||= e.length;
	let i = r - n;
	if (i < 2) return;
	let a = 0;
	if (i < 32) {
		a = ee(e, n, r, t), ne(e, n, r, n + a, t);
		return;
	}
	let o = new re(e, t), s = F(i);
	do {
		if (a = ee(e, n, r, t), a < s) {
			let r = i;
			r > s && (r = s), ne(e, n, n + r, n + a, t), a = r;
		}
...
function R(e) {
	let t = (0, A.default)(new Int32Array(e.shape[0]), [e.shape[0]]), n = (0, A.default)(new Int32Array(e.shape[0]), [e.shape[0]]);
	return j.bands(t, e, 1023), j.lshifts(n, t, 16), j.bxoreq(t, n), j.bandseq(t, 4278190335), j.lshifts(n, t, 8), j.bxoreq(t, n), j.bandseq(t, 50393103), j.lshifts(n, t, 4), j.bxoreq(t, n), j.bandseq(t, 51130563), j.lshifts(n, t, 2), j.bxoreq(t, n), j.bandseq(t, 153391689), t;
}
function ae(e) {
	let t = R(e.pick(null, 0)), n = R(e.pick(null, 1));
	j.lshiftseq(n, 1);
	let r = R(e.pick(null, 2));
	return j.lshiftseq(r, 2), j.boreq(t, n), j.boreq(t, r), t;
}
function z(e, t) {
	if (e.shape[0] !== t.shape[0]) throw Error("wrong length");
	let n = (0, A.default)(new Float32Array(e.size), e.shape, e.stride, e.offset);
	for (let r = 0; r < t.shape[0]; r++) {
		let i = t.get(r);
		if (e.shape.length > 1) for (let t = 0; t < e.shape[1]; t++) n.set(r, t, e.get(i, t));
		else n.set(r, e.get(i));
	}
	return n;
}
function oe(e) {
	let t = j.sup(e), n = j.inf(e), r = 1e3 / Math.min(1e3, t - n), i = (0, A.default)(new Float32Array(e.data), e.shape);
	j.mulseq(i, r);
	let a = ae((0, A.default)(new Int32Array(i.data), e.shape)), o = Array.from(a.data).map((e, t) => [e, t]);
	ie(o, (e, t) => e[0] - t[0]);
	let s = o.map(([e, t]) => t);
	return (0, A.default)(Uint32Array.from(s));
}
var B = class {
	constructor(e, t, n, r, i, a, o, s, c, l) {
		this.propertyDescs = e, this.format = t, this.nsplats = n, this.xyz = r, this.colors = i, this.harmonics = a, this.opacity = o, this.scaling = s, this.rotation = c, this.maxSHDegree = l;
	}
	getPlyBinary() {
		let e = B._generateHeaderString(this.propertyDescs, this.format, this.nsplats), t = new TextEncoder().encode(e), n = Object.keys(this.propertyDescs).length, r = (0, D.default)(new Float32Array(this.nsplats * n), [this.nsplats, n]);
		if (O.assign(r.pick(null, this.propertyDescs.x.index), this.xyz.pick(null, 0)), O.assign(r.pick(null, this.propertyDescs.y.index), this.xyz.pick(null, 1)), O.assign(r.pick(null, this.propertyDescs.z.index), this.xyz.pick(null, 2)), O.assign(r.pick(null, this.propertyDescs.f_dc_0.index), this.colors.pick(null, 0)), O.assign(r.pick(null, this.propertyDescs.f_dc_1.index), this.colors.pick(null, 1)), O.assign(r.pick(null, this.propertyDescs.f_dc_2.index), this.colors.pick(null, 2)), O.assign(r.pick(null, this.propertyDescs.opacity.index), this.opacity.pick(null, 0)), O.assign(r.pick(null, this.propertyDescs.scale_0.index), this.scaling.pick(null, 0)), O.assign(r.pick(null, this.propertyDescs.scale_1.index), this.scaling.pick(null, 1)), O.assign(r.pick(null, this.propertyDescs.scale_2.index), this.scaling.pick(null, 2)), O.assign(r.pick(null, this.propertyDescs.rot_0.index), this.rotation.pick(null, 0)), O.assign(r.pick(null, this.propertyDescs.rot_1.index), this.rotation.pick(null, 1)), O.assign(r.pick(null, this.propertyDescs.rot_2.index), this.rotation.pick(null, 2)), O.assign(r.pick(null, this.propertyDescs.rot_3.index), this.rotation.pick(null, 3)), this.harmonics && this.harmonics.length > 0) for (let e = 0; e < this.harmonics.length; e++) {
			let t = e * 3;
			O.assign(r.pick(null, this.propertyDescs[`f_rest_${t}`].index), this.harmonics[e].pick(null, 0)), O.assign(r.pick(null, this.propertyDescs[`f_rest_${t + 1}`].index), this.harmonics[e].pick(null, 1)), O.assign(r.pick(null, this.propertyDescs[`f_rest_${t + 2}`].index), this.harmonics[e].pick(null, 2));
		}
		let i = new Uint8Array(r.data.buffer), a = new Uint8Array(i.length + t.length);
		return a.set(t), a.set(i, t.length), a.buffer;
	}
	save(e, t) {
		let n = this.getPlyBinary(), r = new Blob([n], { type: "application/octet-stream" }), i = new File([r], e), a = new FormData();
		a.append("file", i), a.append("filename", e), a.append("basedir", t), fetch(`${k}/push_file`, {
			method: "POST",
			body: a
		});
	}
	...
	mortonPositionSplatsSort() {
		let e = oe(this.xyz), t = z(this.xyz, e), n = z(this.colors, e), r = z(this.opacity, e), i = z(this.scaling, e), a = z(this.rotation, e), o = [];
		for (let t = 0; t < this.harmonics.length; t++) o.push(z(this.harmonics[t], e));
		return new B(this.propertyDescs, this.format, this.nsplats, t, n, o, r, i, a, this.maxSHDegree);
	}
	static _generateHeaderString(e, t, n) {
		let r = `ply
format ${t.format} ${t.version}
element vertex ${n}`, i = Object.keys(e).length, a = Array(i);
		for (let t in e) {
			let n = e[t];
			a[n.index] = {
				name: t,
		...
		for (let e = 0; e < a.length; e++) r = `${r}
property ${a[e].dtype} ${a[e].name}`;
		return `${r}
end_header
`;
	}
	static fromArrayBuffer(e, t = 3) {
		let { splatCount: n, vertexData: r, propertiesDesc: i, format: a } = B.decodeHeader(e), o = r.buffer.slice(r.byteOffset), s = Object.keys(i).length, c = (0, D.default)(new Float32Array(o), [n, s]), l = 0, u = {}, d = {
			double: 8,
			int: 4,
			uint: 4,
			float: 4,
		...
		let f = (0, D.default)(new Float32Array(n * 3), [n, 3]);
		O.assign(f.pick(null, 0), c.pick(null, u.x / 4)), O.assign(f.pick(null, 1), c.pick(null, u.y / 4)), O.assign(f.pick(null, 2), c.pick(null, u.z / 4));
		let p = (0, D.default)(new Float32Array(n * 3), [n, 3]);
		O.assign(p.pick(null, 0), c.pick(null, u.scale_0 / 4)), O.assign(p.pick(null, 1), c.pick(null, u.scale_1 / 4)), O.assign(p.pick(null, 2), c.pick(null, u.scale_2 / 4));
		let m = (0, D.default)(new Float32Array(n * 3), [n, 3]);
		O.assign(m.pick(null, 0), c.pick(null, u.f_dc_0 / 4)), O.assign(m.pick(null, 1), c.pick(null, u.f_dc_1 / 4)), O.assign(m.pick(null, 2), c.pick(null, u.f_dc_2 / 4));
		let h = (0, D.default)(new Float32Array(n * 4), [n, 4]);
		O.assign(h.pick(null, 0), c.pick(null, u.rot_1 / 4)), O.assign(h.pick(null, 1), c.pick(null, u.rot_2 / 4)), O.assign(h.pick(null, 2), c.pick(null, u.rot_3 / 4)), O.assign(h.pick(null, 3), c.pick(null, u.rot_0 / 4));
		for (let e = 0; e < n; e++) {
			let t = h.pick(e, null), n = Math.sqrt(t.get(0) ** 2 + t.get(1) ** 2 + t.get(2) ** 2 + t.get(3) ** 2);
			O.divseq(t, n);
		}
		let g = (0, D.default)(new Float32Array(n * 1), [n, 1]);
		O.assign(g.pick(null, 0), c.pick(null, u.opacity / 4)), O.negeq(g), O.expeq(g), O.addseq(g, 1), O.recipeq(g), O.mulseq(g, 255);
		let _ = (Math.min(Math.max(t, 0), 3) + 1) ** 2 - 1, v = [];
		for (let e = 0; e < _; e++) {
			let t = (0, D.default)(new Float32Array(n * 3), [n, 3]), r = e * 3;
			O.assign(t.pick(null, 0), c.pick(null, u[`f_rest_${r}`] / 4)), O.assign(t.pick(null, 1), c.pick(null, u[`f_rest_${r + 1}`] / 4)), O.assign(t.pick(null, 2), c.pick(null, u[`f_rest_${r + 2}`] / 4)), v.push(t);
		}
		return new B(i, a, n, f, m, v, g, p, h, t);
	}
	static async fromPLYFile(e, t = 3) {
		let n = await B.loadFile(e);
		return B.fromArrayBuffer(n, t);
	}
	static decodeHeader(e) {
		let t = new TextDecoder(), n = 0, r = "";
		for (;;) {
			if (n + 100 >= e.byteLength) throw Error("End of file reached while searching for end of header");
			let i = new Uint8Array(e, n, 100);
			r += t.decode(i), n += 100;
			let a = n - 200, o = new Uint8Array(e, Math.max(0, a), a > 0 ? 200 : 100);
			if (t.decode(o).includes("end_header")) break;
		}
		let i = r.split("\n"), a = 0, o = {}, s = {}, c = 0, l;
		for (let e = 0; e < i.length; e++) {
			...
			if (t.startsWith("element vertex")) {
				...
				let e = t.match(/(\w+)\s+(\w+)\s+(\d+\.?\d*)/);
				e && (l = {
					format: e[2],
					version: e[3]
				});
			} else if (t === "end_header") break;
		}
		let u = r.indexOf("end_header") + 10 + 1, d = new DataView(e, u);
		return {
			splatCount: a,
			vertexData: d,
			headerOffset: n,
	...
	constructor(e, t, n, r, i, a, o, s) {
		this.config = e, this.xyz = t, this.scaling = n, this.color = r, this.opacity = i, this.harmonics = o, this.quaternion = a, this.variableChunkSize = s;
	}
	get isDynamicChunks() {
	...
	static compressFromGaussianData(e, t) {
		let n = E.fromArray(e.xyz, t.xyz, t.chunkSize), r = E.fromArray(e.scaling, t.scaling, t.chunkSize), i = E.fromArray(e.colors, t.color, t.chunkSize), a = E.fromArray(e.opacity, t.opacity, t.chunkSize), o = E.fromArray(e.rotation, t.quaternion, t.chunkSize), s = e.harmonics, c = [];
		if (t.harmonics) for (let e = 0; e < s.length; e++) {
			let n = E.fromArray(s[e], t.harmonics, t.chunkSize);
			c.push(n);
		}
		return new V(t, n, r, i, a, o, c);
	}
	_countIndexesInChunks(e) {
		let t = [], n = this.nchunks, r = this.chunkSize, i = this.nsplats;
		if (n === E.getRequiredNChunks(i, r)) for (let n = 0; n < e.length; n++) {
			let r = e[n], i = Math.floor(r / this.chunkSize);
			i in t ? t[i].push(r) : t[i] = [r];
		}
		else {
			let i = this.variableChunkSize, a = {}, o = 0;
			for (let e = 0; e < n; e++) a[e] = o, o += i[e];
			for (let o = 0; o < e.length; o++) {
				let s = e[o], c = Math.min(Math.floor(s / r), n - 1);
				for (; s >= a[c] + i[c];) c++;
	...
	pruneSplats(e) {
		let t = this._countIndexesInChunks(e), n, r = [];
		return t.length > 0 && (n = this.variableChunkSize ? [...this.variableChunkSize] : Array(this.nchunks).fill(this.chunkSize), t.forEach((e, t) => {
			n[t] -= e.length, n[t] <= 0 && r.push(t);
		}), n = n.filter((e) => e > 0)), new V(this.config, this.xyz.pruneFeature(e, r, n), this.scaling.pruneFeature(e, r, n), this.color.pruneFeature(e, r, n), this.opacity.pruneFeature(e, r, n), this.quaternion.pruneFeature(e, r, n), this.harmonics ? this.harmonics.map((t) => t.pruneFeature(e, r, this.variableChunkSize)) : void 0, n);
	}
	...
	toGaussians() {
		...
		if (t.x = {
			...
			dtype: "float",
			index: n
		}, n++, this.harmonics && this.harmonics.length > 0) for (let e = 0; e < this.harmonics.length; e++) t[`f_rest_${e}`] = {
			dtype: "float",
			index: n
		}, n++, t[`f_rest_${e + 1}`] = {
			dtype: "float",
		...
		let r = this.harmonics?.map((e) => e.denormDequant());
		return new B(t, e, this.xyz.length, this.xyz.denormDequant(), this.color.denormDequant(), r || [], this.opacity.denormDequant(), this.scaling.denormDequant(), this.quaternion.denormDequant(), 3);
	}
}, H = u(m(), 1), U = u(y(), 1), W = 1e-6, G = typeof Float32Array < "u" ? Float32Array : Array, K = Math.random;
Math.PI / 180, Math.hypot || (Math.hypot = function() {
...
function se() {
	var e = new G(9);
	return G != Float32Array && (e[1] = 0, e[2] = 0, e[3] = 0, e[5] = 0, e[6] = 0, e[7] = 0), e[0] = 1, e[4] = 1, e[8] = 1, e;
}
function ce(e, t) {
...
c(J, {
	...
	fromRotationTranslationScale: () => pt,
	fromRotationTranslationScaleOrigin: () => mt,
	fromScaling: () => rt,
	fromTranslation: () => nt,
	fromValues: () => He,
	fromXRotation: () => at,
	...
	multiply: () => Ye,
	multiplyScalar: () => At,
	multiplyScalarAndAdd: () => jt,
	ortho: () => St,
	orthoNO: () => xt,
	orthoZO: () => Ct,
	perspective: () => vt,
	perspectiveFromFieldOfView: () => bt,
	perspectiveNO: () => _t,
	perspectiveZO: () => yt,
	rotate: () => Qe,
	rotateX: () => $e,
...
function Je(e) {
	var t = e[0], n = e[1], r = e[2], i = e[3], a = e[4], o = e[5], s = e[6], c = e[7], l = e[8], u = e[9], d = e[10], f = e[11], p = e[12], m = e[13], h = e[14], g = e[15], _ = t * o - n * a, v = t * s - r * a, y = t * c - i * a, b = n * s - r * o, x = n * c - i * o, S = r * c - i * s, C = l * m - u * p, w = l * h - d * p, T = l * g - f * p, E = u * h - d * m, D = u * g - f * m;
...
function it(e, t, n) {
	...
	return o < W ? null : (o = 1 / o, r *= o, i *= o, a *= o, s = Math.sin(t), c = Math.cos(t), l = 1 - c, e[0] = r * r * l + c, e[1] = i * r * l + a * s, e[2] = a * r * l - i * s, e[3] = 0, e[4] = r * i * l - a * s, e[5] = i * i * l + c, e[6] = a * i * l + r * s, e[7] = 0, e[8] = r * a * l + i * s, e[9] = i * a * l - r * s, e[10] = a * a * l + c, e[11] = 0, e[12] = 0, e[13] = 0, e[14] = 0, e[15] = 1, e);
}
function at(e, t) {
	var n = Math.sin(t), r = Math.cos(t);
...
function lt(e, t) {
	var n = new G(3), r = -t[0], i = -t[1], a = -t[2], o = t[3], s = t[4], c = t[5], l = t[6], u = t[7], d = r * r + i * i + a * a + o * o;
	return d > 0 ? (n[0] = (s * o + u * r + c * a - l * i) * 2 / d, n[1] = (c * o + u * i + l * r - s * a) * 2 / d, n[2] = (l * o + u * a + s * i - c * r) * 2 / d) : (n[0] = (s * o + u * r + c * a - l * i) * 2, n[1] = (c * o + u * i + l * r - s * a) * 2, n[2] = (l * o + u * a + s * i - c * r) * 2), ct(e, t, n), e;
}
function ut(e, t) {
...
function mt(e, t, n, r, i) {
	var a = t[0], o = t[1], s = t[2], c = t[3], l = a + a, u = o + o, d = s + s, f = a * l, p = a * u, m = a * d, h = o * u, g = o * d, _ = s * d, v = c * l, y = c * u, b = c * d, x = r[0], S = r[1], C = r[2], w = i[0], T = i[1], E = i[2], D = (1 - (h + _)) * x, O = (p + b) * x, k = (m - y) * x, A = (p - b) * S, j = (1 - (f + _)) * S, M = (g + v) * S, N = (m + y) * C, P = (g - v) * C, F = (1 - (f + h)) * C;
...
function yt(e, t, n, r, i) {
	var a = 1 / Math.tan(t / 2), o;
	return e[0] = a / n, e[1] = 0, e[2] = 0, e[3] = 0, e[4] = 0, e[5] = a, e[6] = 0, e[7] = 0, e[8] = 0, e[9] = 0, e[11] = -1, e[12] = 0, e[13] = 0, e[15] = 0, i != null && i !== Infinity ? (o = 1 / (r - i), e[10] = i * o, e[14] = i * r * o) : (e[10] = -1, e[14] = -r), e;
}
function bt(e, t, n, r) {
...
function Nt(e, t) {
	var n = e[0], r = e[1], i = e[2], a = e[3], o = e[4], s = e[5], c = e[6], l = e[7], u = e[8], d = e[9], f = e[10], p = e[11], m = e[12], h = e[13], g = e[14], _ = e[15], v = t[0], y = t[1], b = t[2], x = t[3], S = t[4], C = t[5], w = t[6], T = t[7], E = t[8], D = t[9], O = t[10], k = t[11], A = t[12], j = t[13], M = t[14], N = t[15];
	return Math.abs(n - v) <= W * Math.max(1, Math.abs(n), Math.abs(v)) && Math.abs(r - y) <= W * Math.max(1, Math.abs(r), Math.abs(y)) && Math.abs(i - b) <= W * Math.max(1, Math.abs(i), Math.abs(b)) && Math.abs(a - x) <= W * Math.max(1, Math.abs(a), Math.abs(x)) && Math.abs(o - S) <= W * Math.max(1, Math.abs(o), Math.abs(S)) && Math.abs(s - C) <= W * Math.max(1, Math.abs(s), Math.abs(C)) && Math.abs(c - w) <= W * Math.max(1, Math.abs(c), Math.abs(w)) && Math.abs(l - T) <= W * Math.max(1, Math.abs(l), Math.abs(T)) && Math.abs(u - E) <= W * Math.max(1, Math.abs(u), Math.abs(E)) && Math.abs(d - D) <= W * Math.max(1, Math.abs(d), Math.abs(D)) && Math.abs(f - O) <= W * Math.max(1, Math.abs(f), Math.abs(O)) && Math.abs(p - k) <= W * Math.max(1, Math.abs(p), Math.abs(k)) && Math.abs(m - A) <= W * Math.max(1, Math.abs(m), Math.abs(A)) && Math.abs(h - j) <= W * Math.max(1, Math.abs(h), Math.abs(j)) && Math.abs(g - M) <= W * Math.max(1, Math.abs(g), Math.abs(M)) && Math.abs(_ - N) <= W * Math.max(1, Math.abs(_), Math.abs(N));
}
var Pt = Ye, Ft = kt, Y = {};
c(Y, {
	add: () => Tn,
...
function tn(e, t) {
	var n = e[0], r = e[1], i = e[2], a = e[3], o = t[0], s = t[1], c = t[2], l = t[3];
	return Math.abs(n - o) <= W * Math.max(1, Math.abs(n), Math.abs(o)) && Math.abs(r - s) <= W * Math.max(1, Math.abs(r), Math.abs(s)) && Math.abs(i - c) <= W * Math.max(1, Math.abs(i), Math.abs(c)) && Math.abs(a - l) <= W * Math.max(1, Math.abs(a), Math.abs(l));
}
(function() {
	var e = Ht();
	return function(t, n, r, i, a, o) {
...
function an(e, t) {
	...
	return r > W ? (e[0] = t[0] / r, e[1] = t[1] / r, e[2] = t[2] / r) : (e[0] = 1, e[1] = 0, e[2] = 0), n;
}
function on(e, t) {
	var n = On(e, t);
...
function fn(e, t) {
	var n = t[0], r = t[1], i = t[2], a = t[3], o = Math.sqrt(n * n + r * r + i * i), s = Math.exp(a), c = o > 0 ? s * Math.sin(o) / o : 0;
	return e[0] = n * c, e[1] = r * c, e[2] = i * c, e[3] = s * Math.cos(o), e;
}
function pn(e, t) {
	var n = t[0], r = t[1], i = t[2], a = t[3], o = Math.sqrt(n * n + r * r + i * i), s = o > 0 ? Math.atan2(o, a) / o : 0;
	return e[0] = n * s, e[1] = r * s, e[2] = i * s, e[3] = .5 * Math.log(n * n + r * r + i * i + a * a), e;
}
function mn(e, t, n) {
	return pn(e, t), Dn(e, e, n), fn(e, e), e;
}
function Q(e, t, n, r) {
	var i = t[0], a = t[1], o = t[2], s = t[3], c = n[0], l = n[1], u = n[2], d = n[3], f, p, m, h, g;
	return p = i * c + a * l + o * u + s * d, p < 0 && (p = -p, c = -c, l = -l, u = -u, d = -d), 1 - p > W ? (f = Math.acos(p), m = Math.sin(f), h = Math.sin((1 - r) * f) / m, g = Math.sin(r * f) / m) : (h = 1 - r, g = r), e[0] = h * i + g * c, e[1] = h * a + g * l, e[2] = h * o + g * u, e[3] = h * s + g * d, e;
}
function hn(e) {
	var t = K(), n = K(), r = K(), i = Math.sqrt(1 - t), a = Math.sqrt(t);
...
var xn = Ut, Sn = Wt, Cn = Gt, wn = Kt, Tn = qt, En = sn, Dn = Jt, On = Qt, kn = $t, An = Yt, jn = An, Mn = Xt, Nn = Mn, $ = Zt, Pn = en, Fn = tn, In = function() {
	var e = It(), t = Rt(1, 0, 0), n = Rt(0, 1, 0);
	return function(r, i, a) {
		var o = Bt(i, a);
		return o < -.999999 ? (X(e, t, i), Vt(e) < 1e-6 && X(e, n, i), zt(e, e), rn(r, e, Math.PI), r) : o > .999999 ? (r[0] = 0, r[1] = 0, r[2] = 0, r[3] = 1, r) : (X(e, i, a), r[0] = e[0], r[1] = e[1], r[2] = e[2], r[3] = 1 + o, $(r, r));
	};
}(), Ln = function() {
	var e = Z(), t = Z();
	return function(n, r, i, a, o, s) {
		return Q(e, r, o, s), Q(t, i, a, s), Q(n, e, t, 2 * s * (1 - s)), n;
	};
}(), Rn = function() {
	var e = se();
	return function(t, n, r, i) {
		return e[0] = r[0], e[3] = r[1], e[6] = r[2], e[1] = i[0], e[4] = i[1], e[7] = i[2], e[2] = -n[0], e[5] = -n[1], e[8] = -n[2], $(t, vn(t, e));
	};
}(), zn = {
	xyz: 3,
	color: 3,
	...
	constructor(e) {
		this.version = "", this._buffer = e;
	}
	get buffer() {
		return this._buffer;
	}
	get decoded() {
		return this._decoded ||= this.decodeBuffer(), this._decoded;
	}
	get colorsA() {
		let e = this.decoded.color.denormDequant(), t = this.decoded.opacity.denormDequant(), n = (0, H.default)(new Float32Array(e.shape[0] * 4), [e.shape[0], 4]);
		return U.mulseq(e, .28209479177387814), U.addseq(e, .5), U.mulseq(e, 255), U.maxseq(e, 0), U.minseq(e, 255), this.version === "" && (U.negeq(t), U.expeq(t), U.addseq(t, 1), U.recipeq(t), U.mulseq(t, 255)), U.assign(n.hi(e.shape[0], 3).lo(0, 0), e), U.assign(n.hi(e.shape[0], 4).lo(0, 3), t), (0, H.default)(new Uint8Array(n.data), [e.shape[0], 4]).data;
	}
	get nsplats() {
	...
	decodeBuffer() {
		let { splatCount: e, chunkCount: t, chunkSize: n, typeChunks: r, vertexData: i, propertiesDesc: a, version: o } = this.decodeHeader();
		this.version = o;
		let s = {
		...
		let c = i.byteOffset, l = Array(Object.keys(a).length);
		for (let e in a) l[a[e].index] = {
			name: e,
			method: a[e].compressionMethod
		};
		let u = t * 2 * 4, d = c, f = r === "dynamic" ? t * 2 : 0, p, m = !1;
		if (f > 0) {
			let e = new Uint16Array(i.buffer.slice(d, d + f));
			d += f, p = Array.from(e), m = !0;
		}
		let h = {};
		for (let r of l) {
			let a = 0, o = !0;
			if (r.method === "norm8x") a = e * 1 * zn[r.name];
			else if (r.method === "norm11") a = e * 4;
			else if (r.method === "norm565") a = e * 2;
			else throw o = !1, /* @__PURE__ */ Error(`Not Implemented format: ${r.method}`);
			let s;
			if (o) {
				let e = i.buffer.slice(d, d + u);
				s = (0, H.default)(new Float32Array(e), [t, 2]), d += u;
			} else throw Error("loading chunk byt hasnot minmax!");
			let c = i.buffer.slice(d, d + a);
			d += a;
			let l;
			if (r.method === "norm8x") l = (0, H.default)(new Uint8Array(c), [e, zn[r.name]]);
			else if (r.method === "norm11") l = (0, H.default)(new Uint32Array(c));
			else if (r.method === "norm565") l = (0, H.default)(new Uint16Array(c));
			else throw Error(`Not Implemented format: ${r.method}`);
			h[r.name] = new E(l, s, n, r.method, p, m);
		}
		let g = [];
		for (let e = 0; e < 15; e++) {
			let t = h[`harmonics_${e}`];
			t && (g.push(t), delete h[`harmonics_${e}`]);
		}
		return g.length > 0 && (h.harmonics = g), new V(s, h.xyz, h.scaling, h.color, h.opacity, h.quaternion, h.harmonics, p);
	}
	buildPreComputedBuffers() {
		let e = this.decoded, t = e.nsplats, n = /* @__PURE__ */ new ArrayBuffer(24 * t), r = new Float32Array(n), i = e.scaling.denormDequant(), a = e.quaternion.denormDequant(), o = Y.create(), s = q.create(), c = q.create(), l = q.create(), u = J.create();
		for (let e = 0; e < t; e++) {
			J.fromScaling(u, [
				Math.exp(i.get(e, 0)),
				Math.exp(i.get(e, 1)),
				Math.exp(i.get(e, 2))
			]), q.fromMat4(c, u), Y.set(o, a.get(e, 0), a.get(e, 1), a.get(e, 2), a.get(e, 3)), q.fromQuat(s, o), q.multiply(l, s, c);
			let t = l;
			r[6 * e] = t[0] * t[0] + t[3] * t[3] + t[6] * t[6], r[6 * e + 1] = t[0] * t[1] + t[3] * t[4] + t[6] * t[7], r[6 * e + 2] = t[0] * t[2] + t[3] * t[5] + t[6] * t[8], r[6 * e + 3] = t[1] * t[1] + t[4] * t[4] + t[7] * t[7], r[6 * e + 4] = t[1] * t[2] + t[4] * t[5] + t[7] * t[8], r[6 * e + 5] = t[2] * t[2] + t[5] * t[5] + t[8] * t[8];
		}
		this._precomputedCovarianceBufferData = n;
	}
	decodeHeader() {
		let e = this._buffer, t = new TextDecoder(), n = 0, r = "";
		for (;;) {
			if (n + 100 >= e.byteLength) throw Error("End of file reached while searching for end of header");
			let i = new Uint8Array(e, n, 100);
			r += t.decode(i), n += 100;
		...
		let i = r.split("\n"), a = 0, o = 0, s = 0, c = 0, l = "", u = "", d = {};
		for (let e = 0; e < i.length; e++) {
			let t = i[e].trim();
			if (t.startsWith("version")) u = t.split(" ")[1] ?? "";
				...
				if (e) {
					let t = e[2];
					d[t] = {
						compressionMethod: e[3],
						index: c
					}, c++;
				}
			} else if (t.startsWith("element chunks")) {
				let e = t.match(/\d+/);
				e && (o = parseInt(e[0]));
			} else if (t.startsWith("element chunkSize")) {
				let e = t.match(/\d+/);
				e && (s = parseInt(e[0]));
			} else if (t.startsWith("element typeChunks")) {
				let e = t.match(/(\w+)\s+(\w+)\s+(\w+)/);
				e && (l = e[3]);
			} else if (t === "end_header") break;
		}
		let f = r.indexOf("end_header") + 10 + 1, p = new DataView(e, f);
		return {
			splatCount: a,
			chunkCount: o,
			chunkSize: s,
	...
	pruneSplats(e) {
		...
		return Bn.fromCompressedGaussianSplats(t, this.version);
	}
	static fromCompressedGaussianSplats(e, t) {
		let n = e.xyz.length, r = e.xyz.nchunks, i = `gspline
version ${t}
element vertex ${n}
element chunks ${r}
